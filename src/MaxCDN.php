...
use Davidsneal\MaxCDN\OAuth\OAuthUtil;
use Davidsneal\MaxCDN\OAuth\OAuthConsumer;
use Davidsneal\MaxCDN\OAuth\OAuthRequest;
use Davidsneal\MaxCDN\OAuth\OAuthSignatureMethod_HMAC_SHA1;
...
class MaxCDN {
	...
	public function __construct() {
		$this->alias  = env('MAXCDN_ALIAS');
		$this->key    = env('MAXCDN_KEY');
		$this->secret = env('MAXCDN_SECRET');
